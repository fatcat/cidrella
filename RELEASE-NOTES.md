...
### Changed
- **Runtime and dependency refresh.** Bundled Node updated to 24.18.0 (security line). Cleared npm audit advisories: axios and form-data (client, high) and body-parser (server, low), plus routine minor updates (Vite 8.1.5, Vue 3.5.40, Vue Router 5.2, better-sqlite3 12.11.1, helmet, express-rate-limit).
