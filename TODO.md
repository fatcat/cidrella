...
- [ ] implement IPv6 for management, DNS, DHCP and blocklists (backend and rogue DHCPv6/RA
      detection landed 2026-09-17; the UI pass remains, tracked in BACKLOG.md under
      "IPv6, in flight")
