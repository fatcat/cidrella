...
const EDITABLE_KEYS = new Set(['default_gateway_position', 'subnet_name_template', 'dns_upstream_servers', 'backup_schedule', 'backup_retention_count', 'geoip_enabled', 'geoip_mode', 'geoip_proxy_port', 'default_scan_interval']);
