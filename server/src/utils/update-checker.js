...
//
// The previous implementation did `.split('.').map(Number)` which turned
// "15-pre" into NaN, `NaN || 0` became 0, and 0.4.15-pre.1 falsely lost to
// 0.4.13 in backup-restore checks. This version mirrors the semver_cmp in
// scripts/lib/slots.sh so both sides of the restore/update flow agree.
