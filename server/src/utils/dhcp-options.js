...
export const DHCP_OPTIONS = [
  ...
  { code: 28,  name: 'broadcast',              label: 'Broadcast Address',          type: 'ip',        dnsmasqName: '28',      group: 'Common',  rfc: 'RFC 2132', rfcUrl: 'https://datatracker.ietf.org/doc/html/rfc2132#section-5.3',  description: 'Broadcast address for the client\'s subnet.' },
