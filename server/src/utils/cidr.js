/**
 * IPv4 CIDR arithmetic shared by the server and the client.
 *
 ...
 * the two ip.js copies diverged on validation, /31 and /32, and the return
 * type of calculateSubnets, and nothing failed. Now there is one body and
 * client/tests/unit/utils/ip-shared.test.js goes red if a client-local fork
 * reappears.
 *
 * All IPs are handled as 32-bit unsigned integers internally for math, and
 * converted to and from dotted-quad strings at boundaries.
 */
