    ...
    const insertAddress = db.prepare(`
      INSERT INTO ip_addresses (
        ...
        address_sort_key
                ...
                'topology', ?, 4, ?)
    `);
    insertAddress.run(subnet.lastInsertRowid, '10.88.0.0', 'network', null,
      'Protected network address', subnet.lastInsertRowid, '4:0a580000');
    insertAddress.run(subnet.lastInsertRowid, '10.88.0.255', 'broadcast', null,
      'Protected broadcast address', subnet.lastInsertRowid, '4:0a5800ff');
    insertAddress.run(subnet.lastInsertRowid, '10.88.0.1', 'gateway', null,
      'Protected system address', subnet.lastInsertRowid, '4:0a580001');
    insertAddress.run(subnet.lastInsertRowid, '10.88.0.2', 'old-cidrella', 'aa:bb:cc:dd:ee:02',
      'Protected system address', subnet.lastInsertRowid, '4:0a580002');
    insertAddress.run(subnet.lastInsertRowid, '10.88.0.3', 'old-service', 'aa:bb:cc:dd:ee:03',
      'Protected system address', subnet.lastInsertRowid, '4:0a580003');
