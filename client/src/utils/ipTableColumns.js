...
const COLUMN_CATALOG = [
  ...
  { key: 'network_range_type', header: 'Network Range Type', description: 'Optional organizational range tag. It does not affect network functionality.', field: 'network_range_type', style: 'width: 11rem' },
  ...
  { key: 'device', header: 'Device OS', description: 'Device type or OS family inferred from DHCP fingerprint data.', field: 'os_family', style: 'width: 9rem' },
  { key: 'os_family', header: 'Operating System', description: 'Best operating-system family inferred from DHCP fingerprint evidence.', field: 'os_family', style: 'width: 10rem' },
  { key: 'device_type', header: 'Device Type', description: 'Best device category inferred from DHCP fingerprint evidence.', field: 'device_type', style: 'width: 9rem' },
  { key: 'device_confidence', header: 'Fingerprint Confidence', description: 'Confidence of the strongest retained device fingerprint.', field: 'device_confidence', style: 'width: 9rem' },
  { key: 'dhcp_fingerprint', header: 'DHCP Fingerprint', description: 'Normalized DHCP option 55 parameter-request list used for classification.', field: 'dhcp_fingerprint', style: 'width: 16rem' },
  { key: 'dhcp_vendor_class', header: 'Vendor Class', description: 'DHCP option 60 vendor-class identifier used for classification.', field: 'dhcp_vendor_class', style: 'width: 12rem' },
  { key: 'dhcp_fingerprint_hostname', header: 'Fingerprint Hostname', description: 'Client hostname captured with the DHCP fingerprint.', field: 'dhcp_fingerprint_hostname', style: 'width: 12rem' },
  { key: 'device_fingerprint_source', header: 'Fingerprint Source', description: 'Whether the device classification was inferred from DHCP or set manually.', field: 'device_fingerprint_source', style: 'width: 9rem' },
