      ...
      <Message v-if="auth.passwordResetBy" severity="warn" :closable="false" class="mb-3">
        <div class="reset-warning">
          ...
          <div class="reset-hint">
            If you did not perform this reset, someone with root access to this host ran
            <code>cidrella-reset-password</code> (or an equivalent SQL update) on your account.
            Treat this host as potentially compromised and investigate who has shell access.
          </div>
        </div>
      </Message>
