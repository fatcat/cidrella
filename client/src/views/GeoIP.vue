...
// (Domain allowlist lives on Filtering › Allowed Domains; the GeoIP IP/CIDR
// allowlist moved to its own Filtering › Allowed IPs sub-tab in v0.4.16,
// see views/settings/GeoIpAllowedIps.vue.)
