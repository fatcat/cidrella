    ...
    >
      <template #empty>
        <EmptyState
          ...
          :title="emptyMessage"
          description="Domains listed here are exempt from category and GeoIP blocking."
        />
      </template>
...
const ctxItems = computed(() =>
  selected.value
    ? [
        {
          label: 'Remove from Allowed Domains',
          icon: 'pi pi-trash',
          command: () => remove(selected.value),
        },
      ]
    : [],
);
