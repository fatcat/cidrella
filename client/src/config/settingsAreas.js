...
export const SETTINGS_AREAS = [
  {
    ...
    icon: 'pi pi-cog',
    group: 'Configuration',
    blurb: 'Network defaults, naming, scanning, VLANs, interfaces',
    dataTrack: 'settings-area-general',
    subtabs: [
      {
        id: 'naming',
        label: 'Naming & Scanning',
      ...
      },
      {
        ...
        dataTrack: 'settings-sec-network-defaults',
        component: defineAsyncComponent(
          () => import('../views/settings/NetworkDefaultsSettings.vue'),
        ),
      },
      {
        id: 'vlans',
      ...
      },
      {
        id: 'interfaces',
        label: 'Interfaces',
        dataTrack: 'settings-sec-interfaces',
  ...
  },
  {
    ...
    icon: 'pi pi-globe',
    group: 'Configuration',
    blurb: 'Forwarders, encryption, DNSSEC, SOA',
    dataTrack: 'settings-area-dns',
    subtabs: [
      {
        id: 'dns',
        label: 'DNS',
        dataTrack: 'settings-sec-dns',
  ...
  },
  {
    ...
    subtabs: [
      ...
      },
      {
        ...
        dataTrack: 'settings-sec-rogue-dhcp',
  ...
  },
  {
    ...
    icon: 'pi pi-filter',
    group: 'Configuration',
    blurb: 'Categories, GeoIP, anomalies',
    dataTrack: 'settings-area-filtering',
    ...
    subtabs: [
      {
        id: 'categories',
        label: 'Categories',
        dataTrack: 'settings-sec-blocklists',
        fill: true,
      ...
      },
      {
        id: 'search',
        label: 'Search',
        dataTrack: 'settings-sec-blocklist-search',
        fill: true,
      ...
      },
      {
        ...
        dataTrack: 'settings-sec-allowed-domains',
        fill: true,
        component: defineAsyncComponent(
          () => import('../views/settings/BlocklistAllowedDomains.vue'),
        ),
      },
      {
        id: 'geoip',
        label: 'GeoIP Rules',
        dataTrack: 'settings-sec-geoip',
        fill: true,
      ...
      },
      {
        id: 'allowed-ips',
        label: 'Allowed IPs',
        dataTrack: 'settings-sec-allowed-ips',
        fill: true,
      ...
      },
      {
        id: 'anomalies',
        label: 'Anomalies',
        dataTrack: 'settings-sec-anomaly',
  ...
  },
  {
    ...
    subtabs: [
      ...
      },
      {
        ...
        dataTrack: 'settings-sec-certificates',
  ...
  },
  {
    ...
    icon: 'pi pi-palette',
    group: 'System',
    blurb: 'Appearance & theme',
    dataTrack: 'settings-area-preferences',
    subtabs: [
      {
        id: 'appearance',
        label: 'Appearance',
        dataTrack: 'settings-sec-themes',
  ...
  },
  {
    ...
    icon: 'pi pi-wrench',
    group: 'System',
    blurb: 'Backup, updates, logs, import',
    dataTrack: 'settings-area-maintenance',
    subtabs: [
      {
        id: 'backup',
        label: 'Backup & Restore',
        dataTrack: 'settings-sec-backups',
    ...
    subtabs: [
      {
        ...
        dataTrack: 'settings-sec-calculator',
        fill: true,
